...
namespace RecursiveGeek.DotNetLib.DotNetNuke
{
    ...
    {
        #region Constants
        public const string DefaultSettingTableName = "RecursiveGeek_Master_Setting";
        public const string DefaultStoredProcGetSetting = "RecursiveGeek_GetSetting";
        public const string DefaultStoredProcSetSetting = "RecursiveGeek_SetSetting";
        #endregion
