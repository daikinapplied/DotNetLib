...
using RecursiveGeek.DotNetLib.Core.Tests.Models.JsonPlaceHolder;
...
namespace RecursiveGeek.DotNetLib.Core.Tests
{
    public class NetworkTests
    {
        ...
        {
            const string fullUrl = "https://www.recursivegeek.com/api/v1?key=value&key2=value2";
            var (url, path, query) = Url.SplitUrl(fullUrl);
            Assert.Equal("https://www.recursivegeek.com", url);
